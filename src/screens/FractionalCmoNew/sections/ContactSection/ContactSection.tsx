...
export const ContactSection = (): JSX.Element => {
  ...
  const services = ["Fractional CMO", "AI Assisted Services"];
  ...
  return (
    <footer className="flex flex-col items-start gap-2.5 pt-[60px] pb-10 px-20 relative self-stretch w-full flex-[0_0_auto] mt-[-5px] bg-[#131313]">
          ...
          <div className="inline-flex flex-col items-start gap-10 relative flex-[0_0_auto]">
            <div className="inline-flex flex-col items-start gap-4 relative flex-[0_0_auto]">
              <img
                ...
                alt="Progrowth Logo"
                src="https://c.animaapp.com/jVCmr5mO/img/vector-26.svg"
              />
            ...
            <button
              className="all-[unset] box-border pl-[26px] pr-3 pt-[9px] pb-[11px] bg-[#ffffff1a] inline-flex items-center gap-[30px] relative flex-[0_0_auto] rounded-[50px] overflow-hidden cursor-pointer hover:bg-[#ffffff26] transition-colors"
            ...
            >
              ...
              <img
                ...
                alt="Arrow"
                src="https://c.animaapp.com/jVCmr5mO/img/arrow-4.svg"
              />
            </button>
          </div>
            ...
            <ul className="flex flex-col items-start gap-3 relative self-stretch w-full flex-[0_0_auto] list-none p-0 m-0">
              {quickLinks.map((link, index) => (
                <li key={index} className="self-stretch">
                  <a
                    href="#"
                    className={`${index === 0 ? "mt-[-1.00px]" : ""} ${index === 2 ? "w-fit mr-[-4.00px]" : "self-stretch"} font-normal text-lg [font-family:'Manrope',Helvetica] text-white tracking-[0] leading-[normal] hover:text-gray-300 transition-colors block`}
                  >
                    {link}
                  </a>
                </li>
            ...
            <ul className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto] list-none p-0 m-0">
              {services.map((service, index) => (
                <li key={index}>
                  <a
                    href="#"
                    className={`w-fit ${index === 0 ? "mt-[-1.00px]" : ""} font-normal text-lg [font-family:'Manrope',Helvetica] text-white tracking-[0] leading-[normal] hover:text-gray-300 transition-colors`}
                  >
                    {service}
                  </a>
                </li>
            ...
            <div className="inline-flex flex-col items-start gap-5 relative flex-[0_0_auto]">
                ...
                >
                  ...
                  <div className="flex items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
                    <img
                      ...
                      alt="Location"
                      src="https://c.animaapp.com/jVCmr5mO/img/distance-1@2x.png"
                    />
              ...
              >
                <img
                  ...
                  alt="LinkedIn icon"
                  src="https://c.animaapp.com/jVCmr5mO/img/linkedin-icon.svg"
                />
              </a>
            </div>
          </div>
